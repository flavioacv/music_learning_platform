            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(
                  colors: [
                    theme.colorScheme.primary.withOpacity(_isPlaying ? 0.4 : 0.2),
              ...
              child: Center(
                child: Icon(
                  ...
                  size: 64,
                  color: theme.colorScheme.primary,
                ).animate(target: _isPlaying ? 1 : 0).scale(begin: const Offset(1, 1), end: const Offset(1.2, 1.2)),
              ),
            ),
